...
annnotations_convert = {
    "four_chamber_heart":{"右心房":1,"右心室":2,"左心室":3,"室间隔":4,"脊柱":5,"左心房":6,"房室间隔十字交叉":7,"降主动脉":8,"肋骨":9,"ROI":10,"左室流出道及主动脉":11,},
    "left_ventricular_outflow_tract":{"右心室":1,"左室流出道及主动脉":2,"左心室":3,"脊柱":4,"室间隔":5,"ROI":6,},
    "right_ventricular_outflow_tract":{"右心室":1,"主肺动脉及动脉导管":2,"脊柱":3,"ROI":4,"左心室":5,"室间隔":6,},
    "three_vessel_tracheal":{"降主动脉":1,"脊柱":2,"主肺动脉及动脉导管":3,"气管":4,"上腔静脉":5,"主动脉弓":6,"ROI":7,},
}
...
class fetus_Dataset(Dataset):
    def __init__(self, opt, operation='train'):
        self.opt = opt
    ...
    def get_hopsital_data(self):
        for hospital in self.opt.selected_hospital:
    ...
    def split_all_data(self, slices, train_ratio=0.7, valid_ratio=0.1, test_ratio=0.2):
        ...
        different_set = list(set(image_keys).difference(set(self.train_set)))
